...
This repository provides a complete Infrastructure-as-Code (IaC) solution for deploying and managing a Google Kubernetes Engine (GKE) cluster using Terraform, with GitOps continuous delivery powered by ArgoCD and automated image updates via ArgoCD Image Updater.
